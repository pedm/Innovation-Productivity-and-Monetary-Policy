...
while ~done
   ...
   if dispIndx
      ...
      disp([sprintf('x = ') sprintf('%15.8g%15.8g%15.8g%15.8g%15.8g',x)]);
      
      % PAT NOTE: MY MODIFICATION SO THAT OUTPUT IS IN TERMS OF PARAMS
      disp([sprintf('p = ') sprintf('%15.8g%15.8g%15.8g%15.8g%15.8g\n',bounds(x))]);
   end
   %-------------------------
   itct=itct+1;
